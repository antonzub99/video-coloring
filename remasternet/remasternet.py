...
class NetworkR( nn.Module ):
   def __init__(self):
      ...
      self.layers = nn.Sequential(
         ...
         TempConv(   1,  32, kernel_size=(3,3,3), stride=(1,2,2), padding=(0,0,0)),
         TempConv(  32, 64, kernel_size=(3,3,3), padding=(1,1,1)),
         # TempConv( 64, 64, kernel_size=(3,3,3), padding=(1,1,1)),
         TempConv( 64, 128, kernel_size=(3,3,3), stride=(1,2,2), padding=(1,1,1)),
         TempConv( 128, 128, kernel_size=(3,3,3), padding=(1,1,1)),
         # TempConv( 256, 256, kernel_size=(3,3,3), padding=(1,1,1)),
         # TempConv( 256, 256, kernel_size=(3,3,3), padding=(1,1,1)),
         # TempConv( 256, 256, kernel_size=(3,3,3), padding=(1,1,1)),
         Upsample( 128, 64 ),
         TempConv( 64,  32, kernel_size=(3,3,3), padding=(1,1,1)),
...
class NetworkC( nn.Module ):
   def __init__(self):
      ...
      self.down2 = nn.Sequential(
         TempConv( 256, 256, stride=(1,2,2) ),
         TempConv( 256, 256 ),
         # TempConv( 512, 512, stride=(1,2,2) ),
         # TempConv( 512, 512 ),
      )
      self.stattn1 = SourceReferenceAttention( 256, 256 ) # Source-Reference Attention
      self.stattn2 = SourceReferenceAttention( 256, 256 ) # Source-Reference Attention
      self.selfattn1 = SourceReferenceAttention( 256, 256 ) # Self Attention
      self.conv1 = TempConv( 256, 256 )
      self.up1 = UpsampleConcat( 256, 256, 256 ) # 1/8
      self.selfattn2 = SourceReferenceAttention( 256, 256 ) # Self Attention
      self.conv2 = TempConv( 256, 128, kernel_size=(3,3,3), stride=(1,1,1), padding=(1,1,1) )
      self.up2 = nn.Sequential(
         Upsample( 128, 64 ), # 1/4
         TempConv( 64, 32, kernel_size=(3,3,3), stride=(1,1,1), padding=(1,1,1) )
      )
      self.up3 = nn.Sequential(
         Upsample( 32, 16 ), # 1/2
         TempConv( 16, 16, kernel_size=(3,3,3), stride=(1,1,1), padding=(1,1,1) )
      )
